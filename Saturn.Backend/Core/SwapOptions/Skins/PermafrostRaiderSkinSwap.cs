...
internal sealed class PermafrostRaiderSkinSwap : SkinSwap
{
    ...
    public override List<SaturnAsset> Assets =>
        new()
        {
            ...
            {
                ParentAsset =
                    "FortniteGame/Content/Characters/CharacterParts/Female/Medium/Heads/CP_Head_F_RenegadeRaiderIce",
                Swaps = new List<SaturnSwap>()
                {
                    ...
                    {
                        Search =
                            "/Game/Characters/Player/Female/Medium/Bodies/F_MED_Renegade_Raider_Fire/Skins/Ice/Materials/F_MED_Renegade_Raider_Ice_Head.F_MED_Renegade_Raider_Ice_Head",
                    ...
                    {
                        Search =
                            "/Game/Characters/Player/Female/Medium/Bodies/F_MED_Renegade_Raider_Fire/Skins/Ice/Materials/F_MED_Renegade_Raider_Ice_Hair.F_MED_Renegade_Raider_Ice_Hair",
            ...
            new SaturnAsset()
            {
                ...
                Swaps = new List<SaturnSwap>()
                {
                    ...
                    {
                        Search =
                            "/Game/Characters/Player/Female/Medium/Bodies/F_MED_Renegade_Raider_Fire/Skins/Ice/Materials/F_MED_Renegade_Raider_Ice_Body.F_MED_Renegade_Raider_Ice_Body",
            ...
            new SaturnAsset()
            {
                ...
                Swaps = new List<SaturnSwap>()
                {
                    ...
                    {
                        Search =
                            "/Game/Characters/Player/Female/Medium/Bodies/F_MED_Renegade_Raider_Fire/Skins/Ice/Materials/F_MED_Renegade_Raider_Ice_FaceAcc.F_MED_Renegade_Raider_Ice_FaceAcc",
