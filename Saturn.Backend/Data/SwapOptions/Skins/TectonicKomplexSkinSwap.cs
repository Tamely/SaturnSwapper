...
internal sealed class TectonicSwap : SkinSwap
{
    public TectonicSwap(string name, string rarity, string icon, MeshDefaultModel swapModel)
    ...
    public override List<SaturnAsset> Assets =>
        new()
        {
            ...
            new SaturnAsset()
            {
                ParentAsset = "Game/Characters/CharacterParts/FaceAccessories/CP_F_MED_NeonGraffitiLava",
                Swaps = new List<SaturnSwap>()
                {
                    new SaturnSwap()
                    {
