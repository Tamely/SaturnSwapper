...
internal sealed class TheImaginedBladeSwap : PickaxeSwap
{
    public TheImaginedBladeSwap(string name, string rarity, string icon, Dictionary<string, string> swaps, EFortRarity rarityEnum)
