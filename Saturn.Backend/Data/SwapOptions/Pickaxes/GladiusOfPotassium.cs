...
internal sealed class GladiusOfPotassiumSwap : PickaxeSwap
{
    public GladiusOfPotassiumSwap(string name, string rarity, string icon, Dictionary<string, string> swaps, EFortRarity rarityEnum)
