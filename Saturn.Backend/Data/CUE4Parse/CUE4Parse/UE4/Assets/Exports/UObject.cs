...
namespace CUE4Parse.UE4.Assets.Exports
{
    ...
    public class UObject : IPropertyHolder
    {
        ...
        public FUnversionedHeader Header { get; set; }
        ...
        public virtual void Deserialize(FAssetArchive Ar, long validPos)
        {
            if (Ar.HasUnversionedProperties)
            {
                ...
                DeserializePropertiesUnversioned(Properties = new List<FPropertyTag>(), Ar, Class, out var unversionedHeader);
        ...
        public void Serialize(List<byte> Ar)
        {
            ...
            {
                Ar.AddRange(BitConverter.GetBytes(0)); // No idea honestly
            }
        }
        ...
        internal static void DeserializePropertiesUnversioned(List<FPropertyTag> properties, FAssetArchive Ar, UStruct struc, out FUnversionedHeader header)
        {
            header = new FUnversionedHeader(Ar);
            if (!header.HasValues)
                return;
            var type = struc.Name;
