...
namespace UAssetAPI.UnrealTypes
{
    ...
    public class FName : ICloneable
    {
        ...
        /// Creates a new FName instance.
        /// </summary>
        /// <param name="asset">The asset hat this FName is bound to.</param>
        /// <param name="mappedName">The mapped name of the text.</param>
        public FName(INameMap asset, FMappedName mappedName)
        {
            Asset = asset;
            Value = new FString(asset.GetNameReference((int)mappedName.NameIndex).Value);
            Number = 0;
        }
