...
namespace UAssetAPI.PropertyTypes.Structs
{
    ...
    public class ViewTargetBlendParamsPropertyData : PropertyData
    {
        ...
        public override byte[] Serialize(UnrealPackage Asset)
        {
            ...
            data.AddRange(BitConverter.GetBytes(BlendTime));
            data.Add((byte)BlendFunction);
            data.AddRange(BitConverter.GetBytes(BlendExp));
            data.AddRange(BitConverter.GetBytes(bLockOutgoing ? 1 : 0));
