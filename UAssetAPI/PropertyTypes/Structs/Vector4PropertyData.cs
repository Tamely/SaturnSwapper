...
namespace UAssetAPI.PropertyTypes.Structs
{
    ...
    public class Vector4PropertyData : PropertyData
    {
        ...
        public override byte[] Serialize(UnrealPackage Asset)
        {
            ...
            {
                data.AddRange(BitConverter.GetBytes(XFloat));
                data.AddRange(BitConverter.GetBytes(YFloat));
                data.AddRange(BitConverter.GetBytes(ZFloat));
                data.AddRange(BitConverter.GetBytes(WFloat));
            }
