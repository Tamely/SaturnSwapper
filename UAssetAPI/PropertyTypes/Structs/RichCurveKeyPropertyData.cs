...
namespace UAssetAPI.PropertyTypes.Structs
{
    public class RichCurveKeyPropertyData : PropertyData
    {
        ...
        public override byte[] Serialize(UnrealPackage Asset)
        {
            ...
            data.AddRange(BitConverter.GetBytes(ArriveTangent));
            data.AddRange(BitConverter.GetBytes(ArriveTangentWeight));
            data.AddRange(BitConverter.GetBytes(LeaveTangent));
            data.AddRange(BitConverter.GetBytes(LeaveTangentWeight));
