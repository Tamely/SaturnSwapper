...
namespace UAssetAPI.PropertyTypes.Objects
{
    ...
    public class DelegatePropertyData : PropertyData<FDelegate>
    {
        ...
        public override byte[] Serialize(UnrealPackage Asset)
        {
            ...
            data.AddRange(BitConverter.GetBytes(Value.Object.Index));
            data.AddRange(BitConverter.GetBytes(Value.Delegate.Index));
            data.AddRange(BitConverter.GetBytes(Value.Delegate.Number));
