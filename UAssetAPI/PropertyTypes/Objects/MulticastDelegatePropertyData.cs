...
namespace UAssetAPI.PropertyTypes.Objects
{
    ...
    public class MulticastDelegatePropertyData : PropertyData<FDelegate[]>
    {
        ...
        public override byte[] Serialize(UnrealPackage Asset)
        {
            ...
            {
                data.AddRange(BitConverter.GetBytes(entry.Object.Index));
                data.AddRange(BitConverter.GetBytes(entry.Delegate.Index));
                data.AddRange(BitConverter.GetBytes(entry.Delegate.Number));
            }
