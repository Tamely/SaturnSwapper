...
internal readonly record struct TypeDefinition(BindingFlags Flags, TypeKind Kind, int Name, int Size, int[] GenericParameters,
    int UnderlyingType, int FieldCount, int FieldStartOffset, int EnumMemberCount, int EnumMemberStartOffset, int MethodCount, 
    int MethodStartOffset, int ConstructorCount, int ConstructorStartOffset, int StaticConstructor)
{
    public readonly BindingFlags Flags = Flags;
    public readonly TypeKind Kind = Kind;
    public readonly int Name = Name;
    public readonly int Size = Size;
    public readonly int[] GenericParameters = GenericParameters;
