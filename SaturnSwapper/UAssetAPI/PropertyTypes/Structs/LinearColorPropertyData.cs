...
namespace UAssetAPI.PropertyTypes.Structs
{
    ...
    public class LinearColorPropertyData : PropertyData<LinearColor> // R, G, B, A
    {
        ...
        public override byte[] Serialize(UnrealPackage Asset)
        {
            ...
            data.AddRange(BitConverter.GetBytes(Value.R));
            data.AddRange(BitConverter.GetBytes(Value.G));
            data.AddRange(BitConverter.GetBytes(Value.B));
            data.AddRange(BitConverter.GetBytes(Value.A));
