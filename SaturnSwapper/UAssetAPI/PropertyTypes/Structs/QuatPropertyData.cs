...
namespace UAssetAPI.PropertyTypes.Structs
{
    ...
    public class QuatPropertyData : PropertyData<FQuat>
    {
        ...
        public override byte[] Serialize(UnrealPackage Asset)
        {
            ...
            {
                data.AddRange(BitConverter.GetBytes(Value.XFloat));
                data.AddRange(BitConverter.GetBytes(Value.YFloat));
                data.AddRange(BitConverter.GetBytes(Value.ZFloat));
                data.AddRange(BitConverter.GetBytes(Value.WFloat));
            }
